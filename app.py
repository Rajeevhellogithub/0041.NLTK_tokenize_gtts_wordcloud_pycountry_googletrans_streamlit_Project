...
def read_aloud(text, language='en'):
    ...
    tts.save("temp.mp3")
    st.audio("temp.mp3", format="audio/mpeg", loop=False)
...
bc_image_path = r"E:\PYTHONCLASSVSCODE\Streamlit\back3.webp"
with open(bc_image_path, "rb") as image_file:
...
# Get user input
with col1:
    paragraph = st.text_area("Enter one paragraph:", height=200)
...
st.sidebar.image("languages.webp", use_column_width=True)
